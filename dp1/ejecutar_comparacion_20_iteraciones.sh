#!/bin/bash
echo "🔄 ================ COMPARACIÓN FITNESS 20 ITERACIONES ================"
echo "📊 Fitness Formula: rutas×1000 + directas×13.5 + escalas×0.75 + velocidad×0.1"
echo ""

echo "🧬 ALGORITMO GENÉTICO (20 iteraciones):"
...
echo ""
echo "🐜 ALGORITMO COLONIA DE HORMIGAS (20 iteraciones):"
echo "Iteración | Rutas | Directas | Escalas | Velocidad | Fitness"
echo "----------|-------|----------|---------|-----------|--------"
...
echo ""
echo "🔍 ================ ANÁLISIS COMPARATIVO 20 ITERACIONES ================"
