...
public class PlanificacionWebSocketHandler extends TextWebSocketHandler {
    ...
    public void afterConnectionClosed(WebSocketSession session, CloseStatus status) {
        ...
        // 🆕 ESTADO EN RAM: Ya no resetear pedidos en BD
        // El estado se maneja completamente en SessionStateManager
        // Cada sesión tiene su propio estado aislado que se limpia automáticamente
        log.debug("📭 WebSocket cerrado. Estados de sesión manejados en RAM.");
