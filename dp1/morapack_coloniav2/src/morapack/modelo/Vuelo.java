...
public class Vuelo {
    ...
    public int getCapacidadMaxima() { return capacidad; } // Alias para getCapacidad()
    public void setCapacidadMaxima(int capacidad) { this.capacidad = capacidad; } // Alias para setCapacidad()
