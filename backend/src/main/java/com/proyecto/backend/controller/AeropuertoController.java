package com.proyecto.backend.controller;
    ...
    public class AeropuertoController {
        ...
        /**
         * Lista todos los aeropuertos en formato simplificado
         * GET /api/aeropuertos/listar
         */
        @GetMapping("/listar")
        public ResponseEntity<List<Map<String, Object>>> listarAeropuertos() {
            List<Map<String, Object>> aeropuertos = aeropuertoService.obtenerTodos()
                .stream()
                .map(a -> {
                    Map<String, Object> item = new HashMap<>();
                    item.put("codigoICAO", a.getCodigoICAO());
                    item.put("ciudad", a.getCiudad());
                    item.put("pais", a.getPais());
                    item.put("husoHorario", a.getHusoHorario());
                    item.put("capacidadAlmacen", a.getCapacidadAlmacen());
                    item.put("latitud", a.getLatitud());
                    item.put("longitud", a.getLongitud());
                    item.put("continente", a.getContinente());
                    item.put("capacidadDisponible", a.getCapacidadDisponible());
                    return item;
                })
